...
import { GetCurrentUserResponseDto, GetUserResponseDto, GetUsersPaginatedResponseDto } from '../dto';
...
export type GetUsersResponse = ClassProperties<typeof GetUsersPaginatedResponseDto>;

export type GetCurrentUserRequest = void;
export type GetCurrentUserResponse = ClassProperties<typeof GetCurrentUserResponseDto>;